...
node)
    ...
    ;;
nginx)
    scp -i SDC.pem ./init.sh ec2-user@ec2-3-134-102-121.us-east-2.compute.amazonaws.com:~/init.sh
    ssh -i SDC.pem ec2-user@ec2-3-134-102-121.us-east-2.compute.amazonaws.com
    ;;
esac